...
const get_info_query = 'SELECT i.tel tel, i.info_email, i.info_desc, u.user_email, u.first_name, u.last_name  FROM consumer INNER JOIN info i on consumer.id = i.consumer_id INNER JOIN user u on consumer.user_id = u.id;'
